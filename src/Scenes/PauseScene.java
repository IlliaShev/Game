...
public class PauseScene extends Scene {
    ...
    public PauseScene(GridPane pane, int FRAME_WIDTH, int FRAME_HEIGHT, LevelScene levelScene) throws FileNotFoundException {
        ...
        continueButton.setStyle("-fx-background-color: red; -fx-text-fill: white; -fx-text-alignment: center");
        ...
        continueButton.setOnMouseExited(mouseEvent -> continueButton.setStyle("-fx-background-color: red; -fx-text-fill: white; -fx-text-alignment: center"));
